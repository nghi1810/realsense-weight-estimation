...
# load models
# Place model files in the project root (or update these paths).
# Download instructions: see README.md → Setup
yolo = YOLO("best.pt")
model = tf.keras.models.load_model("apple_weight.weights.h5")
